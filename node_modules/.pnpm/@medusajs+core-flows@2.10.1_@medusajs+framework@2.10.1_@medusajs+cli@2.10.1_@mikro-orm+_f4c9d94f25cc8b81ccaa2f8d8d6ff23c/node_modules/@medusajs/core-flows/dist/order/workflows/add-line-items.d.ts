...
export declare const addOrderLineItemsWorkflow: import("@medusajs/framework/workflows-sdk").ReturnWorkflow<OrderWorkflow.OrderAddLineItemWorkflowInput & AdditionalData, OrderLineItemDTO[], [import("@medusajs/framework/workflows-sdk").Hook<"setPricingContext", {
    ...
    } & import("../../cart").FindOrCreateCustomerOutputStepOutput & import("@medusajs/framework/workflows-sdk").WorkflowDataProperties<import("../../cart").FindOrCreateCustomerOutputStepOutput> & {
        config(config: {
            name?: string;
        } & Omit<import("@medusajs/orchestration").TransactionStepsDefinition, "next" | "uuid" | "action">): WorkflowData<import("../../cart").FindOrCreateCustomerOutputStepOutput>;
    } & import("@medusajs/framework/workflows-sdk").StepFunctionReturnConfig<import("../../cart").FindOrCreateCustomerOutputStepOutput>;
