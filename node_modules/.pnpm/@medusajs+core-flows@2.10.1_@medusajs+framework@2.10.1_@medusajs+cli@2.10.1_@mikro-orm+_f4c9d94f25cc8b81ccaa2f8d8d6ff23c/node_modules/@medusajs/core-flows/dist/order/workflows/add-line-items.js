...
exports.addOrderLineItemsWorkflow = (0, workflows_sdk_1.createWorkflow)(exports.addOrderLineItemsWorkflowId, (input) => {
    ...
    const variants = (0, workflows_sdk_1.when)("fetch-variants-with-calculated-price", { variantIds }, ({ variantIds }) => {
        ...
        const calculatedPriceContext = (0, workflows_sdk_1.transform)({ pricingContext, items: input.items }, (data) => {
