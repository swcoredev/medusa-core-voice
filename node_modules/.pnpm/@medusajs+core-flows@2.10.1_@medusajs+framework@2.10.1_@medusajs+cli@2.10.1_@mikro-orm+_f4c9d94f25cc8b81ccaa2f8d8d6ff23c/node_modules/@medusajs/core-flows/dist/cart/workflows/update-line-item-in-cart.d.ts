...
export declare const updateLineItemInCartWorkflow: import("@medusajs/framework/workflows-sdk").ReturnWorkflow<UpdateLineItemInCartWorkflowInputDTO & AdditionalData, undefined, [import("@medusajs/framework/workflows-sdk").Hook<"validate", {
    ...
    cart: any;
    item: (import("@medusajs/framework/types").CartLineItemDTO | WorkflowData<import("@medusajs/framework/types").CartLineItemDTO>) & import("@medusajs/framework/types").CartLineItemDTO;
    variantIds: ((string | undefined)[] | WorkflowData<(string | undefined)[]>) & (string | undefined)[];
