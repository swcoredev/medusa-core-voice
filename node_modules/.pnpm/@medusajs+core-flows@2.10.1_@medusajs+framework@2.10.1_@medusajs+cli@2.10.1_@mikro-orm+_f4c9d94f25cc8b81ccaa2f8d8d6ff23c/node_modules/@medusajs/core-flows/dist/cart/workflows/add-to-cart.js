 ...
 * :::
 */
exports.addToCartWorkflow = (0, workflows_sdk_1.createWorkflow)({
    name: exports.addToCartWorkflowId,
    idempotent: false,
}, (input) => {
    ...
    const variants = (0, workflows_sdk_1.when)("should-calculate-prices", { variantIds }, ({ variantIds }) => {
        return !!variantIds.length;
    }).then(() => {
        const pricingContext = (0, workflows_sdk_1.transform)({ cart, items: input.items, setPricingContextResult }, (data) => {
            const baseContext = {
        ...
        const variants = (0, workflows_sdk_1.transform)({ variantsData, calculatedPriceSets }, ({ variantsData, calculatedPriceSets }) => {
