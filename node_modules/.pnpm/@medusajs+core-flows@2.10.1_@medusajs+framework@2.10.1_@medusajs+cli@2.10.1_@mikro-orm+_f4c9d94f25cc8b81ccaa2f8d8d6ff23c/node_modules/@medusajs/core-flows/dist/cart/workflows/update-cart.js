 ...
 */
exports.updateCartWorkflow = (0, workflows_sdk_1.createWorkflow)({
    name: exports.updateCartWorkflowId,
    idempotent: false,
}, (input) => {
    const { data: cartToUpdate } = (0, common_1.useQueryGraphStep)({
        entity: "cart",
        filters: { id: input.id },
        fields: [
            "id",
    ...
    const newRegion = (0, workflows_sdk_1.when)("should-fetch-region", { input }, (data) => {
        return !!data.input.region_id;
    }).then(() => {
        const { data: newRegion } = (0, common_1.useQueryGraphStep)({
            entity: "region",
    ...
    */
    ...
    (0, workflows_sdk_1.when)("should-emit-region-updated", { regionUpdated }, ({ regionUpdated }) => {
    ...
    (0, workflows_sdk_1.when)("should-delete-line-items", { regionUpdated }, ({ regionUpdated }) => {
        return !!regionUpdated;
    }).then(() => {
