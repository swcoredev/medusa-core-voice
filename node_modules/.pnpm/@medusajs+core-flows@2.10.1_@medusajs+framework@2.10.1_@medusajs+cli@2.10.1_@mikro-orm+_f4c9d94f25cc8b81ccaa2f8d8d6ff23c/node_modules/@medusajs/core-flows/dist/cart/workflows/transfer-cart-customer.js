 ...
 */
exports.transferCartCustomerWorkflow = (0, workflows_sdk_1.createWorkflow)({
    name: exports.transferCartCustomerWorkflowId,
    idempotent: false,
}, (input) => {
    ...
    (0, workflows_sdk_1.when)("should-transfer-cart", { shouldTransfer }, ({ shouldTransfer }) => shouldTransfer).then(() => {
