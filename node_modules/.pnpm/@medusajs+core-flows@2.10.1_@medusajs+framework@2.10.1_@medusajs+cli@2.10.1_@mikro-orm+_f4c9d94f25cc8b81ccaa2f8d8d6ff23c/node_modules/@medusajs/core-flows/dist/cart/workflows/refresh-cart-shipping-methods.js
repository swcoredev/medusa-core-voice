...
exports.refreshCartShippingMethodsWorkflow = (0, workflows_sdk_1.createWorkflow)({
    name: exports.refreshCartShippingMethodsWorkflowId,
    idempotent: false,
}, (input) => {
    const fetchCart = (0, workflows_sdk_1.when)("fetch-cart", { input }, ({ input }) => {
        return !input.cart;
    }).then(() => {
    ...
    (0, workflows_sdk_1.when)("should-prepare-shipping-methods", { listShippingOptionsInput }, ({ listShippingOptionsInput }) => {
