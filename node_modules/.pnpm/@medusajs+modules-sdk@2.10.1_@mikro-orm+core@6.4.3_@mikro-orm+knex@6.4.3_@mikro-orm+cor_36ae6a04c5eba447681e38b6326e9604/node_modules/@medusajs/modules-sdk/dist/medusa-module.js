...
class MedusaModule {
     ...
     * @param workerMode
     */
    static async bootstrapAll(modulesOptions, { migrationOnly, loaderOnly, workerMode, cwd, }) {
     ...
     * @param workerMode
     */
    static async bootstrap({ moduleKey, defaultPath, declaration, moduleExports, sharedContainer, moduleDefinition, injectedDependencies, migrationOnly, loaderOnly, workerMode, cwd, }) {
     ...
     * @protected
     */
    static async bootstrap_(modulesOptions, { migrationOnly, loaderOnly, workerMode, cwd = process.cwd(), }) {
        let loadedModules = [];
        const services = [];
        await (0, utils_1.promiseAll)(modulesOptions.map(async (moduleOptions) => {
            ...
            const moduleResolutions = (0, loaders_1.registerMedusaModule)({
                moduleKey,
    ...
    static async bootstrapLink({ definition, declaration, moduleExports, injectedDependencies, cwd, }) {
        ...
        const moduleResolutions = (0, loaders_1.registerMedusaLinkModule)(moduleDefinition, modDeclaration, moduleExports, cwd);
        const logger_ = container.resolve(utils_1.ContainerRegistrationKeys.LOGGER, {
            allowUnregistered: true,
        }) ?? logger;
        try {
    ...
    static async migrateGenerate({ options, container, moduleExports, moduleKey, modulePath, cwd, }) {
        const moduleResolutions = (0, loaders_1.registerMedusaModule)({
            moduleKey,
            moduleDeclaration: {
        ...
        for (const mod in moduleResolutions) {
            const { generateMigration } = await (0, utils_2.loadModuleMigrations)(container, moduleResolutions[mod], moduleExports);
    ...
    static async migrateUp({ options, container, moduleExports, moduleKey, modulePath, cwd, }) {
        const moduleResolutions = (0, loaders_1.registerMedusaModule)({
            moduleKey,
            moduleDeclaration: {
                scope: types_1.MODULE_SCOPE.INTERNAL,
        ...
        container ??= (0, utils_1.createMedusaContainer)();
        for (const mod in moduleResolutions) {
            const { runMigrations } = await (0, utils_2.loadModuleMigrations)(container, moduleResolutions[mod], moduleExports);
    ...
    static async migrateDown({ options, container, moduleExports, moduleKey, modulePath, cwd, }) {
        const moduleResolutions = (0, loaders_1.registerMedusaModule)({
            moduleKey,
            moduleDeclaration: {
                scope: types_1.MODULE_SCOPE.INTERNAL,
        ...
        container ??= (0, utils_1.createMedusaContainer)();
        for (const mod in moduleResolutions) {
            const { revertMigration } = await (0, utils_2.loadModuleMigrations)(container, moduleResolutions[mod], moduleExports);
