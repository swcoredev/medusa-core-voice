...
async function loadModules(args) {
    const { modulesConfig, sharedContainer, sharedResourcesConfig, migrationOnly = false, loaderOnly = false, workerMode = "shared", cwd, } = args;
    const allModules = {};
    const modulesToLoad = [];
...
async function MedusaApp_({ sharedContainer, sharedResourcesConfig, servicesConfig, medusaConfigPath, modulesConfigFileName, modulesConfig, linkModules, remoteFetchData, injectedDependencies = {}, migrationOnly = false, loaderOnly = false, workerMode = "shared", cwd = process.cwd(), } = {}) {
