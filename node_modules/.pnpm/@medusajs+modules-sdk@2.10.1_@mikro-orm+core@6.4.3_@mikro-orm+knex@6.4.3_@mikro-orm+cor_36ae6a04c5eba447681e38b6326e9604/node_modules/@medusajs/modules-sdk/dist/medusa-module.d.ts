...
declare class MedusaModule {
     ...
     * @param workerMode
     */
    static bootstrapAll(modulesOptions: Omit<ModuleBootstrapOptions, "migrationOnly" | "loaderOnly" | "workerMode">[], { migrationOnly, loaderOnly, workerMode, cwd, }: {
        migrationOnly?: boolean;
        loaderOnly?: boolean;
     ...
     * @protected
     */
    protected static bootstrap_<T>(modulesOptions: Omit<ModuleBootstrapOptions, "migrationOnly" | "loaderOnly" | "workerMode" | "cwd">[], { migrationOnly, loaderOnly, workerMode, cwd, }: {
        migrationOnly?: boolean;
        loaderOnly?: boolean;
        workerMode?: "shared" | "worker" | "server";
        cwd?: string;
    ...
    static bootstrapLink({ definition, declaration, moduleExports, injectedDependencies, cwd, }: LinkModuleBootstrapOptions): Promise<{
        [key: string]: unknown;
    }>;
    static migrateGenerate({ options, container, moduleExports, moduleKey, modulePath, cwd, }: MigrationOptions): Promise<void>;
    static migrateUp({ options, container, moduleExports, moduleKey, modulePath, cwd, }: MigrationOptions): Promise<void>;
    static migrateDown({ options, container, moduleExports, moduleKey, modulePath, cwd, }: MigrationOptions): Promise<void>;
}
