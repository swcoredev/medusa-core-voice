...
const registerMedusaModule = ({ moduleKey, moduleDeclaration, moduleExports, definition, cwd, }) => {
...
const registerMedusaLinkModule = (definition, moduleDeclaration, moduleExports, cwd = process.cwd()) => {
    const moduleResolutions = {};
