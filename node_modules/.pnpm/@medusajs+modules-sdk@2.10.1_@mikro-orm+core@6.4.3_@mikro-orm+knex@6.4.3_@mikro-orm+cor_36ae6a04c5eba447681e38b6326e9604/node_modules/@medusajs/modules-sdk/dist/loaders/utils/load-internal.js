...
async function loadInternalModule(args) {
    ...
    dependencies.push(utils_1.ContainerRegistrationKeys.MANAGER, utils_1.ContainerRegistrationKeys.CONFIG_MODULE, utils_1.ContainerRegistrationKeys.LOGGER, utils_1.ContainerRegistrationKeys.PG_CONNECTION, utils_1.Modules.EVENT_BUS);
...
async function loadResources({ container, moduleResolution, discoveryPath, logger, loadedModuleLoaders, }) {
    ...
    try {
        ...
        const discovered = await (0, utils_1.discoverFeatureFlagsFromDir)(flagDir, 1);
