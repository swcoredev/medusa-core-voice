...
class Order {
     ...
     * })
     */
    async requestTransfer(id, body, headers) {
        return await this.client.fetch(`/admin/orders/${id}/transfer`, {
            method: "POST",
            headers,
            body,
        });
     ...
     * })
     */
    async cancelTransfer(id, headers) {
        return await this.client.fetch(`/admin/orders/${id}/transfer/cancel`, {
            method: "POST",
            headers,
        });
    }
     ...
     * })
     */
    async markAsDelivered(id, fulfillmentId, query, headers) {
