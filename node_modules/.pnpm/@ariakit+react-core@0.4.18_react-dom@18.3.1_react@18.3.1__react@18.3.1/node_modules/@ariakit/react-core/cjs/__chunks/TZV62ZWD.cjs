...
function useCollectionStoreProps(store, update, props) {
  _OZM4QA2Vcjs.useUpdateEffect.call(void 0, update, [props.store]);
  _25BPIGZHcjs.useStoreProps.call(void 0, store, props, "items", "setItems");
  return store;
}
function useCollectionStore(props = {}) {
  const [store, update] = _25BPIGZHcjs.useStore.call(void 0, Core.createCollectionStore, props);
