...
var _52OIQPAOcjs = require('./52OIQPAO.cjs');
...
var useFormControl = _WULEED4Qcjs.createHook.call(void 0, 
  function useFormControl2(_a) {
    ...
    const touchOnBlurProp = _OZM4QA2Vcjs.useBooleanEvent.call(void 0, touchOnBlur);
    ...
    props = _IH6KF7WRcjs.useCollectionItem.call(void 0, _7EQBAZ46cjs.__spreadProps.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, { store }, props), { name, getItem }));
    return props;
  }
);
var FormControl = _WULEED4Qcjs.memo.call(void 0, 
  _WULEED4Qcjs.forwardRef.call(void 0, function FormControl2(props) {
