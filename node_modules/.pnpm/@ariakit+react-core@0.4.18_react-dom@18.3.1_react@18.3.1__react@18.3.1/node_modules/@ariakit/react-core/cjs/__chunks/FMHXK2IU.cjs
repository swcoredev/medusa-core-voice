...
var _6PUNKVPOcjs = require('./6PUNKVPO.cjs');
...
function useDialogStoreProps(store, update, props) {
  return _6PUNKVPOcjs.useDisclosureStoreProps.call(void 0, store, update, props);
}
function useDialogStore(props = {}) {
  const [store, update] = _25BPIGZHcjs.useStore.call(void 0, Core.createDialogStore, props);
