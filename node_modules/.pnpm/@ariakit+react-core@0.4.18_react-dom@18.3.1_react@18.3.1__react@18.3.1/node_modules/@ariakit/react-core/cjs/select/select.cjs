...
var _YRMXINGZcjs = require('../__chunks/YRMXINGZ.cjs');



var _4R2KFV2Fcjs = require('../__chunks/4R2KFV2F.cjs');
require('../__chunks/KQX7GMU6.cjs');
...
var useSelect = _WULEED4Qcjs.createHook.call(void 0, function useSelect2(_a) {
  var _b = _a, {
    store,
    name,
    form,
  ...
  const showOnKeyDownProp = _OZM4QA2Vcjs.useBooleanEvent.call(void 0, showOnKeyDown);
  const moveOnKeyDownProp = _OZM4QA2Vcjs.useBooleanEvent.call(void 0, moveOnKeyDown);
  ...
  props = _OZM4QA2Vcjs.useWrapElement.call(void 0, 
    props,
    (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _4R2KFV2Fcjs.SelectScopedContextProvider, { value: store, children: element }),
    [store]
  );
  ...
  const children = /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _jsxruntime.Fragment, { children: [
    value,
    /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _YRMXINGZcjs.SelectArrow, {})
  ] });
  ...
  props = _7EQBAZ46cjs.__spreadProps.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, {
    ...
    ref: _OZM4QA2Vcjs.useMergeRefs.call(void 0, store.setSelectElement, props.ref),
    onKeyDown
  });
  props = _A56OFCFAcjs.usePopoverDisclosure.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, { store, toggleOnClick }, props));
  props = _QYV7ZYAGcjs.useCompositeTypeahead.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, { store }, props));
  return props;
});
var Select = _WULEED4Qcjs.forwardRef.call(void 0, function Select2(props) {
