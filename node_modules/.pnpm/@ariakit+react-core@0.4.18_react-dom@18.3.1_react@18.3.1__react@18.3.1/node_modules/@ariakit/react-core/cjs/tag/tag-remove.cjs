...
var TagName = "button";
var useTagRemove = _WULEED4Qcjs.createHook.call(void 0, 
  function useTagRemove2(_a) {
    ...
    const context = _I64JXNZFcjs.useTagContext.call(void 0, );
    store = store || context;
    ...
    const setRemoveId = _react.useContext.call(void 0, _I64JXNZFcjs.TagRemoveIdContext);
    const valueFromContext = _react.useContext.call(void 0, _I64JXNZFcjs.TagValueContext);
    ...
    const removeOnClickProp = _OZM4QA2Vcjs.useBooleanEvent.call(void 0, removeOnClick);
    ...
    props = _7EQBAZ46cjs.__spreadProps.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, {
      ...
      onClick,
      render: withinTag ? /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _FCZ3IGUBcjs.Role.span, { render: props.render }) : props.render
    });
    return props;
  }
);
var TagRemove = _WULEED4Qcjs.forwardRef.call(void 0, function TagRemove2(props) {
