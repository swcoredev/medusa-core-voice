...
function create(variant, title, props = {}) {
    ...
    return sonner_1.toast.custom((t) => {
        return (React.createElement(toast_1.Toast, { id: t, title: title, description: props.description, dismissable: props.dismissable, variant: variant, action: props.action, icon: props.icon }));
    }, external);
}
function message(
/**
