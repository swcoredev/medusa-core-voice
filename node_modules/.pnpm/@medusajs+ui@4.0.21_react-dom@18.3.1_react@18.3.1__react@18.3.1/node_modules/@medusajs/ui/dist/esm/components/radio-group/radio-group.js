 ...
 */
const ChoiceBox = React.forwardRef(({ className, id, 
/**
...
value, ...props }, ref) => {
    ...
    return (React.createElement(RadixRadioGroup.Item, { ref: ref, className: clx("shadow-borders-base bg-ui-bg-base focus-visible:shadow-borders-interactive-with-focus transition-fg group flex items-start gap-x-2 rounded-lg p-3 outline-none", "hover:enabled:bg-ui-bg-base-hover", "data-[state=checked]:shadow-borders-interactive-with-shadow", "group-disabled:cursor-not-allowed group-disabled:opacity-50", className), ...props, value: value, id: id, "aria-describedby": descriptionId },
        ...
        React.createElement("div", { className: "flex flex-col items-start" },
            ...
            React.createElement(Hint, { className: "txt-small text-ui-fg-subtle group-disabled:text-ui-fg-disabled text-left", id: descriptionId }, description))));
});
