...
export declare class LocalWorkflow {
    ...
    registerStepFailure(idempotencyKey: string, error?: Error | any, context?: Context, subscribe?: DistributedTransactionEvents, forcePermanentFailure?: boolean): Promise<DistributedTransactionType>;
