...
const getRuleAttributesMap = ({ promotionType, applicationMethodType, applicationMethodTargetType, }) => {
    const map = {
        rules: [...ruleAttributes],
        "target-rules": applicationMethodTargetType ===
            utils_1.ApplicationMethodTargetType.SHIPPING_METHODS
            ? [...shippingMethodsAttributes]
            : [...itemsAttributes],
        "buy-rules": applicationMethodTargetType ===
            utils_1.ApplicationMethodTargetType.SHIPPING_METHODS
            ? [...shippingMethodsAttributes]
            : [...itemsAttributes],
    };
