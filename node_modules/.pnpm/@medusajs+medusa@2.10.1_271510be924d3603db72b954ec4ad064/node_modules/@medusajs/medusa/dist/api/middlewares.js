...
const middlewares_59 = require("./store/products/middlewares");
const middlewares_60 = require("./store/regions/middlewares");
const middlewares_61 = require("./store/return-reasons/middlewares");
const middlewares_62 = require("./store/shipping-options/middlewares");
const middlewares_63 = require("./admin/shipping-option-types/middlewares");
exports.default = (0, define_middlewares_1.defineMiddlewares)([
    ...
    ...middlewares_62.storeShippingOptionRoutesMiddlewares,
    ...
    ...middlewares_60.storeRegionRoutesMiddlewares,
    ...
    ...middlewares_63.adminShippingOptionTypeRoutesMiddlewares,
    ...
    ...middlewares_59.storeProductRoutesMiddlewares,
    ...middlewares_61.storeReturnReasonRoutesMiddlewares,
