 ...
 */
export declare const applyAndAndOrOperators: <T extends z.ZodObject<any>>(schema: T) => z.ZodObject<{
    [x: string]: any;
} & {
    $and: z.ZodOptional<z.ZodLazy<z.ZodArray<T, "many">>>;
    $or: z.ZodOptional<z.ZodLazy<z.ZodArray<T, "many">>>;
}, "strip", z.ZodTypeAny, {
    [x: string]: any;
    $and?: unknown;
    $or?: unknown;
