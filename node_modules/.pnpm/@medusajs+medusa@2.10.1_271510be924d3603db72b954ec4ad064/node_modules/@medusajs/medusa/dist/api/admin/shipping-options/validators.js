...
exports.AdminCreateShippingOption = zod_1.z
    ...
    .strict()
    .refine((data) => (0, utils_2.isDefined)(data.type_id) !== (0, utils_2.isDefined)(data.type), {
...
exports.AdminUpdateShippingOption = zod_1.z
    ...
    .strict()
    .refine((data) => {
    const hasType = (0, utils_2.isDefined)(data.type);
    const hasTypeId = (0, utils_2.isDefined)(data.type_id);
