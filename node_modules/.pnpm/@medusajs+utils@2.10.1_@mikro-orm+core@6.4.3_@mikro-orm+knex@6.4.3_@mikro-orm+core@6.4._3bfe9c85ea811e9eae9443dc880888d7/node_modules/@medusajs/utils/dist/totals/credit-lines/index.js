...
function calculateCreditLinesTotal({ creditLines, includesTax, taxRate, }) {
    ...
    const isZero = math_1.MathBN.lte(creditLinesTotal, math_1.MEDUSA_EPSILON);
    return {
        creditLinesTotal: isZero ? math_1.MathBN.convert(0) : creditLinesTotal,
        creditLinesSubtotal: isZero ? math_1.MathBN.convert(0) : creditLinesSubtotal,
        creditLinesTaxTotal: isZero ? math_1.MathBN.convert(0) : creditLinesTaxTotal,
    };
}
