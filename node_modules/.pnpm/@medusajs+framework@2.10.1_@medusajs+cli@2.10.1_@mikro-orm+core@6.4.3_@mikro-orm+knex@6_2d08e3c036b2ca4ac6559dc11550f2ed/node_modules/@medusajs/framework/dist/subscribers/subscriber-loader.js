...
class SubscriberLoader extends resource_loader_1.ResourceLoader {
    constructor(sourceDir, options = {}, container) {
    ...
    validateSubscriber(subscriber, path) {
        ...
        if (!config) {
             ...
             */
            this.logger.warn(`The subscriber in ${path} is missing a config. skipped.`);
            return false;
        }
        if (!config.event) {
            /**
            ...
            if (config_1.configManager.isProduction) {
                ...
                this.logger.warn(`The subscriber in ${path} is missing an event in the config. skipped.`);
            }
            return false;
        }
        ...
        if (events.some((e) => !(typeof e === "string"))) {
             ...
             */
            this.logger.warn(`The subscriber in ${path} has an invalid event config. The event must be a string or an array of strings. skipped.`);
            return false;
        }
        return true;
    }
