...
var _MedusaAppLoader_container, _MedusaAppLoader_customLinksModules, _MedusaAppLoader_medusaConfigPath, _MedusaAppLoader_cwd;
...
class MedusaAppLoader {
    ...
    constructor({ container, customLinksModules, medusaConfigPath, cwd, } = {}) {
        ...
        _MedusaAppLoader_medusaConfigPath.set(this, void 0);
        _MedusaAppLoader_cwd.set(this, void 0);
        ...
        __classPrivateFieldSet(this, _MedusaAppLoader_medusaConfigPath, medusaConfigPath, "f");
        __classPrivateFieldSet(this, _MedusaAppLoader_cwd, cwd, "f");
    }
    ...
    async runModulesMigrations({ moduleNames, action = "run", } = {
        ...
        const migrationOptions = {
            ...
            medusaConfigPath: __classPrivateFieldGet(this, _MedusaAppLoader_medusaConfigPath, "f"),
            cwd: __classPrivateFieldGet(this, _MedusaAppLoader_cwd, "f"),
        };
        if (action === "revert") {
...
_MedusaAppLoader_container = new WeakMap(), _MedusaAppLoader_customLinksModules = new WeakMap(), _MedusaAppLoader_medusaConfigPath = new WeakMap(), _MedusaAppLoader_cwd = new WeakMap();
