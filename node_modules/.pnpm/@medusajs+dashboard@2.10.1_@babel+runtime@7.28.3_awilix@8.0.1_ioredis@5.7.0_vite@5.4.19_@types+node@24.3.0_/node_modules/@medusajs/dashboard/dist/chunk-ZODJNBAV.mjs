...
var promotionsQueryKeys = {
  ...
  listRuleAttributes: (ruleType, promotionType, applicationMethodTargetType) => [
...
var usePromotionRuleAttributes = (ruleType, promotionType, applicationMethodTargetType, options) => {
  const { data, ...rest } = useQuery2({
    ...
    queryFn: async () => sdk.admin.promotion.listRuleAttributes(
      ruleType,
      promotionType,
      applicationMethodTargetType
    ),
