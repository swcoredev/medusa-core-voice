...
var RulesFormField = ({
  ...
  const applicationMethodTargetType = useWatch2({
    control: form.control,
  ...
  return /* @__PURE__ */ jsxs2("div", { className: "flex flex-col", children: [
    /* @__PURE__ */ jsx2(Heading, { level: "h2", className: "mb-2", children: t(
    ...
    /* @__PURE__ */ jsx2(Text, { className: "text-ui-fg-subtle txt-small mb-6", children: t(
