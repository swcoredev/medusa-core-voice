...
export default class FulfillmentModuleService extends FulfillmentModuleService_base implements IFulfillmentModuleService {
    ...
    upsertShippingOptionTypes(data: FulfillmentTypes.UpsertShippingOptionTypeDTO[], sharedContext?: Context): Promise<FulfillmentTypes.ShippingOptionTypeDTO[]>;
    upsertShippingOptionTypes(data: FulfillmentTypes.UpsertShippingOptionTypeDTO, sharedContext?: Context): Promise<FulfillmentTypes.ShippingOptionTypeDTO>;
    updateShippingOptionTypes(id: string, data: FulfillmentTypes.UpdateShippingOptionTypeDTO, sharedContext?: Context): Promise<FulfillmentTypes.ShippingOptionTypeDTO>;
    updateShippingOptionTypes(selector: FulfillmentTypes.FilterableShippingOptionTypeProps, data: FulfillmentTypes.UpdateShippingOptionTypeDTO, sharedContext?: Context): Promise<FulfillmentTypes.ShippingOptionTypeDTO[]>;
     ...
     *  }
     */
    protected static buildGeoZoneConstraintsFromAddress(address: FulfillmentTypes.FilterableShippingOptionForContextProps["address"]): {
        type: string;
    }[];
}
export {};
